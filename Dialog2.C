#pragma	title("Exception Example  --  Version 1.0  --  (Dialog2.C)")
...
static INTERNALADDRESSLIST aial[ ] = { { (PFNINTADD)DialogueException2DlgProc, "DialogueException2DlgProc" },
				       { NULL, NULL } };

INTERNALADDRESS	intaddDialog2 =	 { __FILE__, 0,	aial };

#pragma	subtitle("   Dialogues - Dialogue Procedure")
#pragma	page( )

/* --- DialogueException2DlgProc ----------------------- [ Public ] ---	*/
/*									*/
...
/*     Upon Exit:							*/
/*									*/
/*     DialogueException2DlgProc = Message Handling Result		*/
/*									*/
/* --------------------------------------------------------------------	*/
